...
class Product(models.Model):
    ...
    lender = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='lender_products')
...
class LenderListingRequest(models.Model):
    ...
    lender = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='listing_requests')
    ...
    def __str__(self):
        return f"{self.product_name} - {self.lender.username} ({self.status})"
