...
2. **Renter Portal**:
   - **Single-Page Dashboard**: Single consolidated interface containing earnings overview, equipment submission trigger, live search bar, listing page link, and instant listing deletion.
...
1. **`accounts`**: User management, custom roles (`ADMIN`, `RENTER`, `CUSTOMER`), Renter profiles with payout information, Customer shipping addresses, and SimpleJWT authentication endpoints.
